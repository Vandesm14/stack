...
#[case("intrinsics/record.stack" => Ok(vec![e(ExprKind::Boolean(true)),e(ExprKind::Boolean(true)),e(ExprKind::Boolean(true)),e(ExprKind::Boolean(true)),e(ExprKind::Boolean(true)),e(ExprKind::Boolean(true)),e(ExprKind::Boolean(true)),e(ExprKind::Boolean(true)),e(ExprKind::Boolean(false)),e(ExprKind::Boolean(false)),e(ExprKind::List(vec![e(ExprKind::Symbol(Symbol::new("name".into()))),e(ExprKind::Symbol(Symbol::new("type".into())))])), e(ExprKind::List(vec![e(ExprKind::String("john".into())),e(ExprKind::String("person".into()))])), e(ExprKind::Integer(2))]) ; "record")]
